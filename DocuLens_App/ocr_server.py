"""
DocuLens OCR Server - Unified Version

A FastAPI-based OCR service that processes PDF files using PyMuPDF and pytesseract.
This is the unified, production-ready version combining all fixes and improvements.

Features:
- Fixed SSE string formatting
- Job cleanup mechanism to prevent memory leaks
